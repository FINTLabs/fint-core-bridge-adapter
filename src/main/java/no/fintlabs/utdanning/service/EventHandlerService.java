package no.fint.provider.okonomi.service;
...
import no.fintlabs.utdanning.Handler;
...
public class EventHandlerService {
    ...
    @Autowired
    private no.fint.provider.adapter.event.EventStatusService eventStatusService;
